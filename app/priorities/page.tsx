            ...
            {priorities.map((priority) => (
              ...
              >
                ...
                <div className="relative z-10 px-6 py-10 sm:px-10">
                  ...
                  <h2 className="font-[family-name:var(--font-display)] text-4xl uppercase leading-none text-white sm:text-5xl">
                    {priority.title}
                  </h2>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {keyInitiatives.map((initiative) => (
              <article key={initiative.title} className="rounded-xl border border-white/10 bg-[#0D1B2A]/75 p-5">
                <h3 className="font-[family-name:var(--font-display)] text-2xl uppercase text-white">{initiative.title}</h3>
