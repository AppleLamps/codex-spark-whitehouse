          ...
          <div className="mt-8 space-y-5 border-l border-[#D4A843]/40 pl-5">
            {timelineMilestones.map((milestone) => (
              <article key={milestone.year} className="relative rounded-xl border border-white/10 bg-[#10213f]/80 p-4">
                <span className="absolute -left-7.25 top-5 h-3 w-3 rounded-full bg-[#D4A843]" />
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#D4A843]">{milestone.year}</p>
                <h3 className="mt-2 font-display text-2xl uppercase text-white">{milestone.title}</h3>
        ...
        <Container>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <article className="rounded-xl border border-white/10 bg-[#0D1B2A]/75 p-5">
              ...
              <h3 className="mt-3 font-display text-2xl uppercase">Executive Branch</h3>
            ...
            <article className="rounded-xl border border-white/10 bg-[#0D1B2A]/75 p-5">
              ...
              <h3 className="mt-3 font-display text-2xl uppercase">Legislative Branch</h3>
            ...
            <article className="rounded-xl border border-white/10 bg-[#0D1B2A]/75 p-5">
              ...
              <h3 className="mt-3 font-display text-2xl uppercase">Judicial Branch</h3>
